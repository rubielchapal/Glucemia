...
/**
 * Intro slider where user can swipe through few slides showing the major features of the app before getting into.
 * The user can navigate through each slide using swipe gesture or using the next button
 * This activity is show only when the app is launched for the first time.
 */
public class WelcomeActivity extends AppCompatActivity {
    ...
    private void launchHomeScreen(int status) {
